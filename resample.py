...
(I have change it to convert from 44.1kHz to 22.05kHz)
...
if __name__ == '__main__':
    ...
    out_fr = 22050 #note: original was: 44100
    out_nbits = in_nbits
    
    # Filter Design
    L = 1         # Upsampling Factor, original was 147
    M = 2         # Downsampling Factor, original was 160
